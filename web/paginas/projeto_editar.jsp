        ...
        <div class="container">
            ...
            <div id="contentor">
                ...
                <div id="conteudo">
                    ...
                    <br/>
                    <form class="form-horizontal" role="form" action="./projectoServlet?comando=editar" method="POST">

                        <div class="form-group">
                            <label class="col-xs-3 control-label">Id:</label>
                            <div class="col-xs-4">
                                <input type="text" class="form-control" id="id_projecto" name="id_projecto" value="<%=projeto.getIdProjecto()%>" readonly="readonly"/>
                            </div>                   
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <input type="text" class="form-control" id="codigo_projecto" name="codigo_projecto" value="<%=projeto.getCodigoProjecto()%>"/>
                            </div>                   
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <input type="text" class="form-control" id="nome_projecto" name="nome_projecto" value="<%=projeto.getNomeProjecto()%>"/>
                            </div>                   
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8" >
                                <textarea class="form-control" rows="5" id="descricao_projecto" name="descricao_projecto" value="<%=projeto.getDescricaoProjecto()%>" ></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-5" >
                                <input type="text"  class="form-control" id="curso_projecto" name="curso_projecto" value="<%=projeto.getCustoProjecto()%>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-5" >
                                <input type="text"  class="form-control" id="financiador_projecto" name="financiador_projecto" value="<%=projeto.getEntidadeFinanciadora()%>"/>
                            </div>
                        </div>

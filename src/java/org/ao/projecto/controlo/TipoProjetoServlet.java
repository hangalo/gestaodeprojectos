...
import org.ao.projecto.dao.TipoProjetoDAO;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (comando == null || !comando.equalsIgnoreCase("principal")) {
            try {
                ...
                if (idTipoProjeto != null) {
                    tipoProjeto.setIdTipoProjecto(Integer.parseInt(idTipoProjeto));
                }
        ...
        try {
            ...
            if (comando.equalsIgnoreCase("guardar")) {
                ...
                tipoProjeto.setNomeTipoProjecto(request.getParameter("nome_tipo_projeto"));

                tipoProjetoDAO.save(tipoProjeto);
                response.sendRedirect("paginas/tipo_projeto_guardar.jsp");

            } else if (comando.equalsIgnoreCase("editar")) {
                tipoProjeto.setIdTipoProjecto(Integer.parseInt(request.getParameter("id_tipo_projeto")));
                tipoProjeto.setNomeTipoProjecto(request.getParameter("nome_tipo_projeto"));
                ...
                tipoProjeto = tipoProjetoDAO.findById(tipoProjeto.getIdTipoProjecto());
